...
export default function HeroWithForm() {
  ...
  return (
    <div
      className="relative bg-cover bg-center h-[700px] sm:flex items-center justify-between sm:px-10"
      style={{
    ...
    >
      ...
      <div className="bg-[#47517c] text-white py-14 px-8 rounded-lg shadow-lg w-full max-w-sm z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 rounded cursor-pointer"
          >
            Get Quick Quote
          </button>
        </form>
